        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?= Yii::t('fileapi', 'MODAL_TITLE') ?></h4>
                </div>
                <div class="modal-body">
                    <div id="modal-preview"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?= Yii::t('fileapi', 'MODAL_CANCEL') ?></button>
                    <button type="button" class="btn btn-primary crop"><?= Yii::t('fileapi', 'MODAL_SAVE') ?></button>
                </div>
            </div>
        </div>
    </div>
